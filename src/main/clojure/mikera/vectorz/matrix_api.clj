(ns mikera.vectorz.matrix-api
  ...
  (:require [clojure.core.matrix :refer :all]
            [clojure.core.matrix.macros :refer [error doseq-indexed]]
  ...
  (:import [mikera.matrixx AMatrix Matrixx Matrix]
           ...
           [mikera.vectorz AVector Vectorz Vector AScalar Vector3 Ops Op Op2]
           [mikera.vectorz Scalar]
           [mikera.vectorz FnOp FnOp2]
           [mikera.vectorz.impl IndexVector ASparseIndexedVector SparseHashedVector ZeroVector SparseIndexedVector]
           [mikera.arrayz Arrayz INDArray Array]
           [mikera.arrayz.impl SliceArray]
           [mikera.indexz AIndex Index]
           [java.util List Arrays]
           [java.io Writer]
           [mikera.transformz ATransform]
           [mikera.matrixx.decompose QR IQRResult Cholesky ICholeskyResult ICholeskyLDUResult]
           [mikera.matrixx.decompose SVD ISVDResult LUP ILUPResult Eigen IEigenResult]
